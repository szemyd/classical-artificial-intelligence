    ...
    **********************************************************************
    ...
    def get_action(self, state):
        ...
        **********************************************************************
        ...
        # self.queue.put(self.iterative_deepening(state, depth_limit=2))
    ...
    def iterative_deepening(self, state, depth_limit):
        ...
        for depth in range(1, depth_limit + 1):
            # print("==========")
            # print("DEPTH = ", depth)
            if self.timertest(): return best_move
    ...
    def timertest(self):
        if self.timertest_off: return False
        if (time.time() - self.start_time) * 1000 > self.max_time: return True ## in milliseconds
        else: return False
